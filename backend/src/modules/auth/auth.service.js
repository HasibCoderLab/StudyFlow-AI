...
import { generateDummyPlan } from "../studyPlan/studyPlan.service.js";
...
export const registerUser = async (userData) => {
  const { name, email, password, classLevel, goal, subjects, examDate } =
    userData;
...
/**
 * Refresh tokens using valid refresh token (token rotation)
 */
