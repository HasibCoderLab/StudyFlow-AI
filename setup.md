...
2. **New +** বাটনে ক্লিক করে **Web Service** সিলেক্ট করুন।
   ...
   > [!IMPORTANT]
   > **সতর্কতা:** ভুল করে **Static Site** সিলেক্ট করবেন না! ব্যাকএন্ডের জন্য অবশ্যই **Web Service** সিলেক্ট করতে হবে। অন্যথায় আপনার ব্যাকএন্ড কোড রান করবে না এবং স্ক্রিনে "Publish Directory" এর মতো অপশন দেখতে পাবেন।
